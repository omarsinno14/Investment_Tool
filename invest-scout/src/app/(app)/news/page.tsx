...
export default function NewsPage() {
  ...
  async function load() {
    setLoading(true);
    try {
      const res = await fetch("/api/opportunities?type=news", { cache: "no-store", credentials: "include" });
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Scraped market headlines and investment news.</p>
        </div>
